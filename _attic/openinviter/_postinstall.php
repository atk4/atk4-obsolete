...
if (!extension_loaded('curl') OR !function_exists('curl_init'))
	...
	{ 
	display_message("<b>libcurl</b> is installed. Using <b>cURL</b> to handle requests<br>\n");
	$curlVersion=curl_version();
	if (empty($curlVersion['ssl_version'])) display_message("<b>OpenSSL</b> is not installed.- OpenInviter will not run correctly on this system.<br>\n"); 
	}
